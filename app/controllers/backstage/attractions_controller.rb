class Backstage::AttractionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @attraction.update(attraction_params)
        format.html { redirect_to backstage_attraction_path(@attraction), notice: "Attraction was successfully updated." }
  ...
  def destroy
    @attraction.destroy
    respond_to do |format|
      format.html { redirect_to backstage_attractions_url, notice: "Attraction was successfully destroyed." }
  ...
  private
    ...
    def attraction_params
      params.require(:attraction).permit(:name, :short_name, :permalink, :"venue_permalink")
    end
